...
class Mountee_mcp extends EE_Cocoa {
    ...
    function api_list_snippets($instructions)
    {
		$sql = "SELECT 	snippet_id,
						snippet_name,
						snippet_contents
    ...
    function api_read_snippet_data($instruction)
    {
    	$this->_snippet_data($instruction->snippet_id);
    }
    ...
    function api_list_variables($instructions)
    {
		$sql = "SELECT 	variable_id,
						variable_name,
						variable_data
    ...
    function api_read_variable_data($instructions)
    {
		$this->_variable_data($instructions->variable_id);
    }
    ...
    function api_list_templates_for_group($instructions)
    {
		$sql = "SELECT 	t.template_id,
						t.group_id,
						t.template_name,
				...
				JOIN	".$this->EE->db->dbprefix."template_groups g 	ON g.group_id = t.group_id
				WHERE	g.site_id = ".$this->DEFAULT_SITE_ID."
				AND		g.group_id = ".$this->EE->db->escape($instructions->group_id);
    ...
    function api_read_template_data($instructions)
    {
    	$this->_template_data($instructions->template_id);
    }
